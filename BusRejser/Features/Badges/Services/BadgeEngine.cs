...
namespace BusRejser.Features.Badges.Services
{
	public class BadgeEngine
	{
		...
		private bool IsBadgeUnlocked(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
		...
		private bool HasCompletedTrips(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
			return history.Count >= badge.RequiredValue;
		}

		private bool HasEarlyBooking(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
		...
		private bool HasLastMinuteBooking(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
		...
		private bool HasUniqueDestinations(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
			return history
		...
		private bool HasBackToBackTrips(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
		...
		private bool HasDoubleTrouble(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
		...
		private bool HasNightRider(Badge badge, List<BusRejserLibrary.Models.TravelHistory> history)
		{
