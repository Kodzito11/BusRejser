...
namespace BusRejser.Features.Progression.Services
{
	public class ProgressionService
	{
		...
		public List<QuestProgressResponse> GetQuests(int userId)
		{
			...
			var locations = _visitedLocationRepository.GetByUserId(userId);
			var territories = BuildTerritories(locations);
			var municipalities = BuildMunicipalities(locations);

			return BuildQuests(locations, territories, municipalities);
		}

		private static List<QuestProgressResponse> BuildQuests(
