...
namespace BusRejserLibrary.Migrations
{
    ...
    [Migration("20260523023431_AddEmailVerificationTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.Booking", b =>
                {
                    ...
                    b.ToTable("booking", null, t =>
                        {
                            t.HasCheckConstraint("CK_booking_status", "Status IN (0, 1, 2, 3)");
                        });
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.EmailVerificationToken", b =>
                {
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.GeoAdmin2Code", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("geo_admin2_codes", (string)null);
                });

            modelBuilder.Entity("BusRejserLibrary.Models.GeoAlternateName", b =>
                {
                    b.Property<int>("GeoAlternateNameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("GeoAlternateNameId"));
                    ...
                    b.HasKey("GeoAlternateNameId");

                    b.HasIndex("GeoNameId");

                    b.ToTable("geo_alternate_names", (string)null);
                });

            modelBuilder.Entity("BusRejserLibrary.Models.GeoNamePlace", b =>
                {
                    b.Property<int>("GeoNameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("GeoNameId"));
                    ...
                    b.HasIndex("CountryCode", "Admin1Code");

                    b.HasIndex("CountryCode", "Admin1Code", "Admin2Code");

                    b.ToTable("geoname_places", (string)null);
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.ProgressionTerritory", b =>
                {
                    b.Property<int>("ProgressionTerritoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ProgressionTerritoryId"));
                    ...
                    b.HasKey("ProgressionTerritoryId");

                    b.HasIndex("Key")
                        .IsUnique();

                    b.ToTable("progression_territories", (string)null);
                });

            modelBuilder.Entity("BusRejserLibrary.Models.ProgressionTerritoryAlias", b =>
                {
                    b.Property<int>("ProgressionTerritoryAliasId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ProgressionTerritoryAliasId"));
                    ...
                    b.HasKey("ProgressionTerritoryAliasId");

                    b.HasIndex("ProgressionTerritoryId", "Value")
                        .IsUnique();

                    b.ToTable("progression_territory_aliases", (string)null);
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.Rejse", b =>
                {
                    ...
                    b.HasIndex("ProgressionTerritoryId");
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.TravelHistory", b =>
                {
                    ...
                    b.ToTable("travel_history", (string)null);
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.VisitedLocation", b =>
                {
                    ...
                    b.ToTable("visited_locations", (string)null);
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.GeoAlternateName", b =>
                {
                    b.HasOne("BusRejserLibrary.Models.GeoNamePlace", "GeoNamePlace")
                        .WithMany()
                        .HasForeignKey("GeoNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeoNamePlace");
                });
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.ProgressionTerritoryAlias", b =>
                {
                    b.HasOne("BusRejserLibrary.Models.ProgressionTerritory", "Territory")
                        .WithMany("Aliases")
                        .HasForeignKey("ProgressionTerritoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusRejserLibrary.Models.Rejse", b =>
                {
                    b.HasOne("BusRejserLibrary.Models.ProgressionTerritory", "ProgressionTerritory")
                        .WithMany()
                        .HasForeignKey("ProgressionTerritoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ProgressionTerritory");
                });
